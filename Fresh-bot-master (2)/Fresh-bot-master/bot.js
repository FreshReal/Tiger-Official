...
Scire pe chat numarul corespunzator videoclipului pe care vrei sa il asculti `)
    ...
    if (!serverQueue) return message.channel.send('There is nothing playing that I could skip for you.')
        ...
        if (!serverQueue) {
            ...
            .setColor("#15f153")
            .addField("Eroare", "Fresh nu este pe un Voice Channel")
            .setTimestamp();
        ...
        if (message.guild.voiceConnection) message.guild.voiceConnection.disconnect();
            ...
            .setColor("#15f153")
            .addField("Fresh s-a deconectat",":x:")
            .setTimestamp();
...
**Now playing:** ${serverQueue.songs[0].title}
        ...
        case "help" :
            ...
            .addField("Add Fresh on your server", '> https://discordapp.com/oauth2/authorize?client_id=460830315276140556&scope=bot&permissions=2146958591')
            .setTimestamp();
        ...
        case "server-info":
            ...
            .addField("Ai intrat in **Fresh** la:", message.member.joinedAt)
        ...
        case "sexy":  
            ...
            .setColor("#15f153")
            .addField("Sanse", message.author.username + " este sexy in proportie de " + r1[Math.floor(Math.random() * r1.length)])
            .setTimestamp();
    ...
    .addField('Raspunsul lui Fresh:', r4[Math.floor(Math.random() * r4.length)])
    .setTimestamp()
    message.channel.sendMessage(E1); 
            break;
            case "bani" :
...
bot.login("NDYwODMwMzE1Mjc2MTQwNTU2.DhPoiw.hzUuItkL64LbWpkqNxGA2Tn5GZ0");
